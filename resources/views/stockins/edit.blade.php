...
@section('content')
<h1 class="text-3xl font-bold mb-6 text-green-700">Edit Stock</h1>
...
<form action="{{ route('stockins.update', $stockin->Stock_ID) }}" method="POST" class="bg-white p-6 rounded shadow">
    ...
    <div class="flex gap-2">
        <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Update Stock</button>
